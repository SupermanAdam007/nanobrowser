...
import { SessionLogSettings } from './components/SessionLogSettings';

type TabTypes = 'general' | 'models' | 'firewall' | 'analytics' | 'sessions' | 'help';
...
const TABS: { id: TabTypes; icon: React.ComponentType<{ className?: string }>; label: string }[] = [
  ...
  { id: 'sessions', icon: FiDatabase, label: 'Sessions' },
...
const Options = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'sessions':
        return <SessionLogSettings isDarkMode={isDarkMode} />;
      default:
        return null;
    }
  };
